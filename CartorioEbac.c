...
#include <locale.h> //biblioteca de aloação de texto por região
...
int registro() //Função responsavel por cadastrar os usuários no sistema
{
  ...
  char sobrenome[40];
  char cargo[40];
  //final da criação de variáeis/string
  ...
  file= fopen(arquivo,"a"); //cria o arquivo e o "a" é o arquivo a ser aberto
